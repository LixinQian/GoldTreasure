...
@interface GTPhoneSucceedView ()

@property (nonatomic, strong) GTAuthSuccessInfoView *authInfoView;

@end

@implementation GTPhoneSucceedView
...
{
    NSSet *markedSet = [NSSet setWithObjects:@"运营商认证", @"风控审核", nil];
    ...
    UILabel *tipLabel = [UILabel labelWithFont:[GTFont gtFontF3] textColor:[GTColor gtColorC6] text:@"运营商认证六个月更新一次，请及时认证。\n如有疑问，请联系客服："];
