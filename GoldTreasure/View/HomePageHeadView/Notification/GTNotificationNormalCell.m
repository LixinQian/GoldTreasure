...
@interface GTNotificationNormalCell ()
...
@implementation GTNotificationNormalCell
...
{
    NSString *logo = (model.logo == nil) ? @"" : model.logo;
    [_icon sd_setImageWithURL:[NSURL URLWithString:logo]];
    _title.text = (model.mTitle == nil) ? @"" : model.mTitle;
    _time.text = (model.createTime == nil) ? @"" : [model.createTime substringFromIndex:5];
    _details.text = (model.content == nil) ? @"" : model.content;
